...
var config = {
    app: {
        buildDir: 'backend/tuanchego/static/app/',
        js: {
            src: [
    ...
    vendor: {
        ...
        js: {
            src: [
                ...
                '!frontend/vendor/**/wysihtml-toolbar.js',
                '!frontend/vendor/**/zxcvbn.js',
                '!frontend/vendor/**/password_strength.js',
                '!frontend/vendor/**/django_formset.js',
            ],
            fileName: 'vendor.js',
        },
        css: {
