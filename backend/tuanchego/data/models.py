...
class City(BaseModel):
	...
	is_hot = models.NullBooleanField(null = True, blank=True,  verbose_name=u'是否热门', default=False )
...
class SysParam(BaseModel):
	...
	class Meta:
		verbose_name=u'系统参数'
		verbose_name_plural=u'系统参数'

class Content(BaseModel):
	"""
	内容页
	"""
	title = models.CharField(max_length=256, db_index=True, null=True, blank=True, verbose_name=u'标题' )
	content = models.TextField(null=True,blank=True, verbose_name=u'内容')
	uri = models.CharField(max_length=32, null=True, blank=True ,db_index=True, verbose_name=u'短地址')
	status = models.CharField(max_length=16, null=True, blank=True, db_index=True, verbose_name=u'状态',
